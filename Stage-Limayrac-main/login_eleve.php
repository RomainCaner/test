...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM utilisateur WHERE loginUser = :login AND roleUser = 'E' AND estActifUser = 1";
    ...
    if ($user && password_verify($password, $user['mdpUser'])) {
        ...
        // Rediriger vers la page d'accueil des étudiants
...
<head>
    ...
    <title>Connexion Étudiant - Portail des Stages</title>
...
<body>
    ...
    <main>
        <section class="login-form">
            ...
            <form action="login_eleve.php" method="post">
